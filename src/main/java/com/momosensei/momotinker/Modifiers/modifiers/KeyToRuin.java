...
public class KeyToRuin extends momomodifier {
    ...
    public Component validate(IToolStackView tool, ModifierEntry modifier) {
        if (tool.getItem()==MomotinkerItem.entropy_burning_cube.get()||tool.getItem()==MomotinkerItem.legion.get()){
            return null;
        }
    ...
    public void onInventoryTick(IToolStackView tool, ModifierEntry modifier, Level world, LivingEntity entity, int index, boolean isSelected, boolean isCorrectSlot, ItemStack stack) {
        if (stack.getItem() == MomotinkerItem.entropy_burning_cube.get()&&entity instanceof Player player){
            ItemStack item = createNewTool(stack,MomotinkerItem.legion.get(), MomotinkerToolDefinitions.LEGION);
    ...
    public void addTooltip(IToolStackView tool, ModifierEntry modifierEntry, @org.jetbrains.annotations.Nullable Player player, List<Component> tooltip, TooltipKey tooltipKey, TooltipFlag tooltipFlag) {
        if (tool.getItem()==MomotinkerItem.legion.get()) {
