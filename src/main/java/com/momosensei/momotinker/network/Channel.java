...
public class Channel {
    ...
    public static void init() {
        ...
        INSTANCE.messageBuilder(BoxPacket.class, id++, NetworkDirection.PLAY_TO_SERVER).decoder(BoxPacket::decode).encoder(BoxPacket::encode).consumerMainThread(BoxPacket::handlePacket).add();
