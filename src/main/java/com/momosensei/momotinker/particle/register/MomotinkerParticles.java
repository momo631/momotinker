...
import com.momosensei.momotinker.particle.AscendingCutParticle;
import com.momosensei.momotinker.particle.HugSmashDownBoomParticle;
import com.momosensei.momotinker.particle.SmashDownBoomParticle;
...
public class MomotinkerParticles {
    ...
    public static void onClientSetup(RegisterParticleProvidersEvent event) {
        Minecraft.getInstance().particleEngine.register(MomotinkerParticles.smash_down_boom.get(), SmashDownBoomParticle.Provider::new);
        Minecraft.getInstance().particleEngine.register(MomotinkerParticles.hug_smash_down_boom.get(), HugSmashDownBoomParticle.Provider::new);
        Minecraft.getInstance().particleEngine.register(MomotinkerParticles.ascending_cut.get(), AscendingCutParticle.Provider::new);
