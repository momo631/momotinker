...
//    public static final RegistryObject<SimpleParticleType> PLAYER_RAINBOW = PARTICLE_TYPES.register("player_rainbow", () -> new SimpleParticleType(true));
...
//       Minecraft.getInstance().particleEngine.register(MomotinkerParticles.RAINBOW.get(), RainbowParticle.Provider::new);
//       Minecraft.getInstance().particleEngine.register(MomotinkerParticles.PLAYER_RAINBOW.get(), PlayerRainbowParticle.Provider::new);
