...
import com.momosensei.momotinker.entity.PullAEntity;
...
public class PullAEntityRenderer extends EntityRenderer<PullAEntity> {
	...
	public PullAEntityRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn);
        this.itemRenderer = renderManagerIn.getItemRenderer();
    }

	@Override
	public void render(PullAEntity entity, float yaw, float tickDelta, PoseStack matrices, MultiBufferSource provider, int light) {
		matrices.pushPose();
	...
	@Override
	public ResourceLocation getTextureLocation(PullAEntity entity) {
