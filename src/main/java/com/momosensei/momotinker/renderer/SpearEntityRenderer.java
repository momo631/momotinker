...
import static com.momosensei.momotinker.entity.SpearEntity.getMold;
...
public class SpearEntityRenderer extends EntityRenderer<SpearEntity> {
    ...
    public void render(SpearEntity entity, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        if (entity.tickCount >= 0 || !(this.entityRenderDispatcher.camera.getEntity().distanceToSqr(entity) < 12.25D)) {
            ...
            matrixStackIn.mulPose(Axis.XP.rotationDegrees(270));
            ...
            this.itemRenderer.renderStatic(entity.getSpear(), ItemDisplayContext.GROUND, packedLightIn, OverlayTexture.NO_OVERLAY, matrixStackIn, bufferIn,entity.level(), entity.getId());
            matrixStackIn.popPose();
            super.render(entity, entityYaw, partialTicks, matrixStackIn, bufferIn, packedLightIn);
        }
    }

    protected int getSkyLightLevel(SpearEntity p_114509_, BlockPos p_114510_) {
        return 15;
    }
    protected int getBlockLightLevel(SpearEntity p_114496_, BlockPos p_114497_) {
        return 15;
    }
