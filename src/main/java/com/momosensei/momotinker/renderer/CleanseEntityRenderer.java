...
public class CleanseEntityRenderer extends EntityRenderer<CleanseEntity> {
    ...
    public void render(CleanseEntity entity, float entityYaw, float p_114487_, PoseStack matrixStackIn, MultiBufferSource p_114489_, int p_114490_) {
        ...
        matrixStackIn.mulPose(Vector3f.YP.rotationDegrees(entity.tickCount%180));
        ...
        this.itemRenderer.renderStatic(new ItemStack(MomotinkerItem.cleanse_item.get()), ItemTransforms.TransformType.GROUND, p_114490_, OverlayTexture.NO_OVERLAY, matrixStackIn, p_114489_, entity.getId());
