...
public class MomotinkerEntities {
    ...
    public static final RegistryObject<EntityType<TriggerSlashEntity>> trigger_slash_a = registerTriggerSlash("trigger_slash",MomotinkerEntities.trigger_slash_a,9);
