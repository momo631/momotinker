...
public final class ModFeatures extends MomotinkerModule {
    ...
    public static final RegistryObject<ConfiguredFeature<TreeConfiguration, Feature<TreeConfiguration>>> jujube_wood_TREE = CONFIGURED_FEATURES.registerSupplier(
        "jujube_wood_tree", () -> Feature.TREE,
