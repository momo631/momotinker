...
public class key {
    ...
    public static class KeyBinding {
        ...
        public static final KeyMapping KEYA = new KeyMapping(KEY_TOOL_ENHANCEMENTE_MOD, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_Z,KEY_KEY);
