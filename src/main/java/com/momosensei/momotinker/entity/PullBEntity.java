...
public class PullBEntity extends Projectile {
    public ToolStack tool;
    private boolean isPullingBlock = false;
    private boolean isPullingEntity = false;
    public PullBEntity(EntityType<? extends Projectile> p_37248_, Level p_37249_) {
        super(p_37248_, p_37249_);
        this.setNoGravity(true);
    }
    public PullBEntity(Level level, double x, double y, double z, Vec3 movement){
        this(MomotinkerEntities.pull_b_entity.get(), level);
        this.setPos(x,y,z);
    ...
    protected void onHitEntity(@NotNull EntityHitResult p_37259_) {
        ...
        if(!this.level.isClientSide && getOwner() instanceof Player player && p_37259_.getEntity() != player) {
            if((p_37259_.getEntity() instanceof LivingEntity || p_37259_.getEntity() instanceof EnderDragonPart)&& !(p_37259_.getEntity() instanceof PullBEntity)) {
