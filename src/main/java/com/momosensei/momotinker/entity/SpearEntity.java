    ...
    public void tick() {
        ...
        if (entity instanceof Player player) {
            ...
            for (Entity targets : ls0) {
                if (targets!=getOwner()) {
                    attackUtil.attackEntity(this.tool, player, InteractionHand.MAIN_HAND, targets, ()->1, true, Util.getSlotType(InteractionHand.MAIN_HAND), this.damage, false, true, false, true);
                }
            }
        }
    }
